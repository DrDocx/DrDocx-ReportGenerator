...
namespace ReportGenCLI
{
	static class Program
	{
		static void Main(string[] args)
		{
			...
			PatientData patient = new PatientData(){name = "John Doe",preferredName = "Johnny",dob = "1/1/2020"};
			...
			List<string> testGroupNames = new List<string>(new string[] {
				"Halstead-Reitan Battery (*Mitrushina et al, 2005 meta-norms where applicable)",
			...
			InsertPicture(newfilePath, imagePath);
		...
		public static void insertPatientData(PatientData patient, string templatePath, string newfilePath)
		{
			...
			using (var stream = new MemoryStream())
			{
				...
				using (WordprocessingDocument doc = WordprocessingDocument.Open(stream, true))
				{
					...
					InsertText(doc,"NAME", patient.name);
					InsertText(doc,"PREFERRED_NAME", patient.preferredName);
				}
		...
		public static WordprocessingDocument InsertText(WordprocessingDocument doc, string contentControlTag, string text)
		{
